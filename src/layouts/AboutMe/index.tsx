  ...
  return (
    <div className="about" id="nav.me">
      ...
      <div className="aboutme">
        ...
        <p className="aboutme__text">{t('con.freetime')}</p>
        <div className="details">
          <label className="details__label">
            {t('det.age')}:<span className="details__span">27</span>
          </label>
          <label className="details__label">
            {t('det.address')}:<span className="details__span">Porto Alegre/RS</span>
          </label>
          <label className="details__label">
            {t('det.experience')}:<span className="details__span">6 {t('det.years')}</span>
          </label>
          <label className="details__label">
            {t('det.position')}:<span className="details__span">Front-end Engineer</span>
          </label>
        </div>
      </div>
    </div>
