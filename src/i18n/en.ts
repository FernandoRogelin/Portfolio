export default {
  ...
  // AboutMe content
  'con.name':
    "My name's Fernando Rogelin, I've been working as Front-end Engineer since 2018 and I made a lot of projects in my career, some of them you'll see in this Portfolio.",
  ...
  'fernando.portfolio':
    'Website show a best collection of my projects made by myself, the website show one compilation of the best services or products, professional projects and others achievements, helping people to know more about me, my skills and my personal jobs, you can see how to contact me too. This website contains a selection of the most relevant works I have worked on my career as a Front-end developer.',
  'website.text':
    'It is a collection of web pages organized and hosted on a server in the network. A website can cover various topics and provide information in the form of text content and media.',
  ...
  'desktop.text':
    'Desktop application is applications that is installed and can run on desktop or laptop. Is applications that can be executed on portable devices like phones, tablets and others.',

  // Contact
  'con.message': 'Send to me a message',
  'con.info':
    "If you liked my work and want to talk with me about a freela, send an e-mail for me and I'll return you as soon as possible, we schedule a chat and I'll see what I can do for you.",
  'con.ariaLabel': 'icon to access my profile',
} as const
